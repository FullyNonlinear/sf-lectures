...
Proof.
  intros p. destruct p as [m n]. simpl. reflexivity. Qed.
(** [] *)
...
Proof.
  ...
  (* prove  forall n:nat, (n =? n) = true.*)
  induction n as [| n' IHn'].
  - simpl. reflexivity.
  (* TODO: figure out why the following simpl work. *)
  - simpl. rewrite -> IHn'. reflexivity. Qed.
(** [] *)
...
Proof.
  intros d x y o. simpl. intros H. rewrite H. reflexivity. Qed.
(** [] *)
End PartialMap.
